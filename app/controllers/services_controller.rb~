				...
				if auth
					...
					if email != ''
						...
						if existinguser
							...
							user.confirm!
							# μήνυμα και είσοδος
							flash[:myinfo] = 'Ο λογαριασμός σας στο σχολείο μετά το σχολείο έχει δημιουργηθεί μέσω' + provider.capitalize + '. Στο προφίλ σας μπορείτε να αλλάξετε τις προσωπικές σας πληροφορίες και να προσθέσετε κάποιον κωδικό ασφαλείας.'
							sign_in_and_redirect(:user, user)
						end
					else
						flash[:error] =  service_route.capitalize + ' δεν μπορεί να χρησιμοποιηθεί για την εγγραφή σας στο σχολείο μετά το σχολείο μιας και δεν παρέχεται κάποιο έγκυρο email. Παρακαλώ χρησιμοποιήστε άλλο πάροχο αυθεντικοποίησης ή χρησιμοποιήστε το σύστημα πιστοποίσης της παρούσας σελίδας. Εάν έχετε ήδη κάποιο λογαριασμό κάνετε είσοδο και προσθέστε το ' + service_route.capitalize + ' στο προφίλ σας.'
