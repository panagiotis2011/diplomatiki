...
require 'openid/store/filesystem'
  ...
  if Rails.env.development?
     ...
     provider :facebook, '303767306344343', '11193324352b3c009165ca20030e3ae2', :scope => ',email,offline_access,publish_checkins,publish_stream,read_stream,publish_actions,manage_pages', :client_options => {:ssl => {:ca_file => "/usr/lib/ssl/certs/ca-certificates.crt"}}
