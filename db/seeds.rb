...
@question6 = Question.create! :title => 'Αποσύνδεση της υπηρεσίας Facebook', :state => 4, :message => '', :submitted => Time.now - 2.day, :accepted => Time.now, :body => "Πως μπορεί ο χρήστης να αποσυνδέσει από την σελίδα
τον λογαριασμό του *Facebook*;
...
@Άσκηση1 = Exercise.create! :etitle => 'PLS50-2011-E01', :ebody => 'Άσκηση 1'
@Άσκηση2 = Exercise.create! :etitle => 'PLS50-2011-E02', :ebody => 'Άσκηση 2'
@Άσκηση3 = Exercise.create! :etitle => 'PLS50-2011-E03', :ebody => 'Άσκηση 3'
@Άσκηση4 = Exercise.create! :etitle => 'PLS51-2011-E01', :ebody => 'Άσκηση 4'
@Άσκηση5 = Exercise.create! :etitle => 'PLS51-2011-E02', :ebody => 'Άσκηση 5'
@Άσκηση6 = Exercise.create! :etitle => 'PLS51-2011-E03', :ebody => 'Άσκηση 6'
@Άσκηση7 = Exercise.create! :etitle => 'PLS51-2011-E04', :ebody => 'Άσκηση 7'
@Άσκηση8 = Exercise.create! :etitle => 'PLS60-2011-E01', :ebody => 'Άσκηση 8'
@Άσκηση9 = Exercise.create! :etitle => 'PLS60-2011-E02', :ebody => 'Άσκηση 9'
@Άσκηση10 = Exercise.create! :etitle => 'PLS60-2011-E03', :ebody => 'Άσκηση 10'
@Άσκηση11 = Exercise.create! :etitle => 'PLS60-2011-E04', :ebody => 'Άσκηση 11'
@Άσκηση12 = Exercise.create! :etitle => 'PLS61-2011-E01', :ebody => 'Άσκηση 12'
