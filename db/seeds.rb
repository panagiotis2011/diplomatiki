...
@student4.confirm!
@student5 = Student.create! :email => 'foititis@diplomatiki.gr', :password => '12345678', :fullname => 'student one', :lesson_id => '1', :weburl => 'http://www.diplomatiki.eu', :shortbio => 'Short biography of Student1'
@student5.confirm!


@article1 = Article.create! :title => 'Article No. 1', :state => 1, :message => '', :submitted => Time.now - 2.day, :accepted => '', :body => "h1. Article 1", :student_id => 5
@article2 = Article.create! :title => 'Article No. 2', :state => 1, :message => '', :submitted => Time.now - 2.day, :accepted => '', :body => "h1. Article 2", :student_id => 5
@article3 = Article.create! :title => 'Article No. 3', :state => 2, :message => '', :submitted => Time.now - 2.day, :accepted => '', :body => "h1. Article 3", :student_id => 5
@article4 = Article.create! :title => 'Article No. 4', :state => 3, :message => '', :submitted => Time.now - 2.day, :accepted => Time.now, :body => "h1. Article 4", :student_id => 5
@article5 = Article.create! :title => 'Article No. 5', :state => 4, :message => '', :submitted => Time.now - 2.day, :accepted => Time.now, :body => "h1. Article 5", :student_id => 5
