...
@student1 = Student.create! :email => 'one@diplomatiki.eu', :password => '12345678', :fullname => 'student One Admin', :lesson_id => '1', :weburl => 'http://www.diplomatiki.eu', :shortbio => 'Short biography of Admin'
@student1.confirm!
@student2 = Student.create! :email => 'two@diplomatiki.eu', :password => '12345678', :fullname => 'student Two', :lesson_id => '2', :weburl => 'http://www.diplomatiki.eu', :shortbio => 'Short biography of student2'
@student2.confirm!
