...
class QuestionsControllerTest < ActionController::TestCase
	...
	setup do
		@question_student1 = questions(:one)
		@question_student6 = questions(:three)
	end
	...
	test "should show question anonymous" do
		get :show, :id => @question_student1.to_param
		assert_response :success
	end
	...
	test "should not get new and edit anonymous" do
		get :new
		assert_redirected_to new_student_session_path
		get :edit, :id => @question_student1.to_param
		assert_redirected_to new_student_session_path
	end
	...
	test "new question has to belong to current student" do
		sign_in students(:student6)
		get :new
		assert assigns(:question).student_id == students(:student6).id, "Η ερώτηση δεν ανήκει στον φοιτητή"
	end
	test "should get edit to own question signed in" do
		sign_in students(:student6)
		get :edit, :id => @question_student6.to_param
		assert_response :success
	end
	test "edited question has to belong to current student" do
		sign_in students(:student6)
		get :edit, :id => @question_student1.to_param
		assert_redirected_to root_url, "Should be redirected to root url if question of other student is requested"
	...
	test "should not create question anonymous" do
		assert_no_difference('Question.count') do
			post :create, :question => @question_student1.attributes
		end
	end
	test "should not create question linked to other student" do
		sign_in students(:student6)
		post :create, :question => { :student_id => students(:student1).id, :title => 'Title', :body => 'Body' }
		puts assigns(:question).student_id
		assert assigns(:question).student_id == students(:student6).id, "Η ερώτηση δεν ανήκει στον φοιτητή"
	end
	test "should create question signed in" do
		sign_in students(:student6)
		assert_difference('Question.count', 1, "Question count has not changed") do
			post :create, :question => { :student_id => students(:student6).id, :title => 'Title', :body => 'Body' }
		end
	...
	test "should not update question anonymous" do
		put :update, :id => @question_student1.to_param, :question => @question_student1.attributes
		assert_redirected_to new_student_session_path
	end
	test "should update question signed in" do
		sign_in students(:student6)
		put :update, :id => @question_student6.to_param, :question => @question_student6.attributes
		assert_redirected_to question_path(assigns(:question))
	end
	test "should not update question linked to other student" do
		sign_in students(:student6)
		put :update, :id => @question_student1.to_param, :question => @question_student1.attributes
		assert_redirected_to root_url, "Should be redirected to root url if question of other student is requested"
		assert_equal 'Η ερώτηση που ζητήσατε δεν βρέθηκε.', flash[:error]
	...
	test "should not submit question anonymous" do
		put :submit, :id => @question_student1.to_param
		assert_redirected_to new_student_session_path
	end
	test "should not submit question for other student" do
		sign_in students(:student6)
	...
	test "should not destroy question anonymous" do
		assert_no_difference('Question.count') do
			delete :destroy, :id => @question_student1.to_param
		end
		assert_redirected_to new_student_session_path
	end
	test "should destroy question signed in" do
		sign_in students(:student6)
			assert_difference('Question.count', -1) do
				delete :destroy, :id => @question_student6.to_param
			end
			assert_redirected_to questions_path
		end
	test "should not destroy question linked to other student" do
		sign_in students(:student6)
